...
public class MarioGame {
    ...
    private MarioResult gameLoop(String level, int timer, int marioState, boolean visual, int fps, int lives, MarioWorld world) {
        ...
        var marioLevel = new MarioLevel(level, false);
        ...
        int mx = this.world.mario.getMapX(), my = this.world.mario.getMapY();
        marioLevel.setAStar(mx, my);
        ...
        while (this.world.gameStatus == GameStatus.RUNNING) {
            if (!this.pause) {
                ...
                mx = this.world.mario.getMapX();
                my = this.world.mario.getMapY();
                marioLevel.setAStar(mx, my);
        ...
        // System.out.println(marioLevel.getLevelString());
        this.world.setAStarResult(marioLevel.getLevelString());
